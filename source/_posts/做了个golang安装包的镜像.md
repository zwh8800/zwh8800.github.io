...
-  闲扯
-  golang
index_img: "/images/thumbs/1f5556f01de37fc838e02d1c4d7a6682.webp"
---


国内下载 golang 安装包还是挺蛋疼的。虽然现在 docker 镜像是个比较好的选择，但还是有很多场景需要原始的 golang 环境的。所以抽空做了个 mirror ，定时拉取 golang 官网的安装包到我的服务器上。
