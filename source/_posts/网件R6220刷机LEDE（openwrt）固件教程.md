...
-  openwrt
-  lede
index_img: "/images/thumbs/1a797a80091c5a2290a090407be0801f.webp"
---
...
一开始我是在 [恩山无限论坛](http://www.right.com.cn/forum/thread-208580-1-1.html) 下载的网友编译的固件，他的固件本身集成了好多功能，不爱折腾的人刷他的固件用自带的功能就够用了，但是他的固件有个问题，固件的内核版本不是官方的版本，没办法安装官方软件仓库里的 kmod 软件包（可以强制安装，但是会大几率无限重启），另外固件的 opkg 好像也没有配置好，安装软件包会比较折腾。所以我建议还是先刷网友版，然后升级成官方版。
